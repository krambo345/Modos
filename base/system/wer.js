...
function insertFunctions(win){
  ...
  header.innerHTML += `<img src="/base/system/icons/${win.dataset.windowicon}.png" class="windowicon"></img><span>${win.dataset.windowname}</span><button class="minimwin" onclick="minimwin(this.closest('.win'))">-</button><button class="closewin" onclick="closewin(this.closest('.win'))">x</button>`
}
function minimwin(e){
